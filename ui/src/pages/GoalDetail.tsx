...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("goals.detail.breadcrumbGoals"), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("goals.detail.breadcrumbFallback") }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("goals.detail.subGoals", { count: childGoals.length })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("goals.detail.projects", { count: linkedProjects.length })}
          </TabsTrigger>
        </TabsList>
